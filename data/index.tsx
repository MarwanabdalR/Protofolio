...
export const projects = [
  {
    ...
    img: "/Dashboard.PNG",
    iconsList: ["/next.svg", "/ts.svg", "/tailwind.svg", "/firebase.svg", "/node.svg", "/framer-motion.svg", "/vercel.svg", "/cloudinary.svg"],
  ...
  },
  {
    ...
    iconsList: ["/vercel.svg", "/ts.svg", "/tailwind.svg", "/next.svg", "/ai.svg"],
  ...
  },
  {
    ...
    img: "/e-prova.png",
    iconsList: ["/react.svg", "/js.svg", "/tailwind.svg", "/framer-motion.svg", "/stripe.svg", "/ai.svg", "/node.svg", "/vercel.svg", "/cloudinary.svg"],
  ...
  },
  {
    ...
    des: "A user-Activity Tracker is Rest API that allows admins to track their activities. Built with Node.js, TypeScript, and Express.js.",
    img: "/user-activity- tracker.jpg",
    iconsList: ["/node.svg", "/ts.svg", "/docker.svg", "/kafka.svg", "/jest.svg"],
    link: "https://github.com/MarwanabdalR/EyegoTask/blob/master/docs/API_DOCUMENTATION.md",
    sourceCode: "https://github.com/MarwanabdalR/EyegoTask",
  },
  {
    id: 5,
    title: "Web Builder",
    ...
    img: "/webbuilder.PNG",
    iconsList: ["/react.svg", "/ts.svg", "/node.svg", "/ai.svg", "/tailwind.svg"],
  ...
  },
  {
    ...
    iconsList: ["/next.svg", "/ts.svg", "/tailwind.svg", "/vercel.svg"],
    link: "https://assement-alpha.vercel.app/",
    sourceCode: "https://github.com/MarwanabdalR/Assement",
  },
  {
    id: 7,
    title: "متتبع الاموال",
    ...
    iconsList: ["/vercel.svg", "/js.svg", "/tailwind.svg"],
